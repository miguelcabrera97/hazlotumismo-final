            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
              ...
              <form action="{{route('crear')}}" method="POST">
                ...
                @enderror
                 ...
                 <button onclick="CrearSitio()" id="CrearSitio" class="m-2  items-center p-3 text-md text-center font-bold text-white bg-fuchsia-500 hover:bg-fuchsia-400 rounded-lg dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" value="Crear mi Sitio" >Crear Sitio</button>
              </form>
            </div>
          </div>
        </div>
